...
# CB: Command for running/testing on android device from scratch
npm install & cordova prepare & npm run build:cordova & cordova build android & cordova run android
